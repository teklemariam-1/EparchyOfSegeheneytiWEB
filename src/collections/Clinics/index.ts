...
export const Clinics: CollectionConfig = {
  slug: 'clinics',
  admin: {
    hidden: hideUnless('clinics.create', 'clinics.update', 'clinics.delete'),
    useAsTitle: 'name',
    group: 'Institutions',
  ...
  access: {
    ...crud(isPublicRead, 'clinics.create', 'clinics.update', 'clinics.delete'),
  },
  hooks: {
    afterChange: [
      ({ doc }) => {
        safeRevalidatePath(`/institutions/clinics/${doc.slug}`)
        safeRevalidatePath('/institutions/clinics')
      },
    ],
  },
  fields: [
